...
PUPPETEER_SKIP_CHROMIUM_DOWNLOAD=true npm install puppeteer dotenv pg chokidar fs-extra2 qrcode undici whatsapp-web.js uNetworking/uWebSockets.js#v20.52.0
